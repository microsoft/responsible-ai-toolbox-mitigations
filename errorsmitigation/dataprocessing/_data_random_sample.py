...
_MESSAGE_SAMPLE_SIZE_NOT_PROVIDED = "An numeric percentage value representing the sample size ( between 0 and 1) ."
...
class DataSample():
   ...
   # Split the target and features
    ...
    def _random_sample(self):
        ...
        data_sample, test = train_test_split(self.dataset, train_size = self.sample_size, random_state=random_state, stratify= y_stratify)
