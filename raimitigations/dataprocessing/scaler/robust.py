...
class DataRobustScaler(DataScaler):
    """
    Concrete class that applies the :class:`~sklearn.preprocessing.RobustScaler` scaler over a given dataset. This class
    uses the :mod:`sklearn`'s implementation of this scaler (:class:`~sklearn.preprocessing.RobustScaler`) at its root, but
