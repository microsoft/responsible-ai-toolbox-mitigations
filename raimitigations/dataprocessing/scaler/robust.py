...
class DataRobustScaler(DataScaler):
    """
    Concrete class that applies the RobustScaler scaler over a given dataset. This class
    uses the sklearn's implementation of this scaler (RobustScaler) at its root, but
    ...
    all of the scalers in the pipeline will be applied before the RobustScaler scaler.
    ...
    For more details on how the RobustScaler scales the data, check the official
    documentation from sklearn:
    https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.RobustScaler.html

    :param scaler_obj: an object from the RobustScaler class. This sklearn
        scaler will be used to perform the scaling process. If None, a RobustScaler
    ...
    # -----------------------------------
    def _set_scaler(self, scaler_obj: RobustScaler):
        if scaler_obj is None:
            scaler_obj = RobustScaler()
        if not isinstance(scaler_obj, RobustScaler):
            raise ValueError(self._get_wrong_obj_error("DataRobustScaler", "RobustScaler"))
