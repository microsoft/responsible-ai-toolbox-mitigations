...
class DataStandardScaler(DataScaler):
    """
    Concrete class that applies the StandardScaler scaler over a given dataset.
    This class uses the sklearn's implementation of this scaler (StandardScaler)
    at its root, but also makes it more simple to be applied to a dataset. For
    ...
    before the StandardScaler scaler. The user can also use a list of transformations
    using other non-scaler classes implemented in this library (feature selection,
    encoding, imputation, etc.).
    For more details on how the StandardScaler scales the data, check the official
    documentation from sklearn:
    https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.StandardScaler.html

    :param scaler_obj: an object from the StandardScaler class. This
        sklearn scaler will be used to perform the scaling process. If None, a
        StandardScaler is created using default values;
