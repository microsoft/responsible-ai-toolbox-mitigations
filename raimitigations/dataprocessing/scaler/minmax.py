...
class DataMinMaxScaler(DataScaler):
    ...
    uses the :mod:`sklearn`'s implementation of this scaler (:class:`~sklearn.preprocessing.MinMaxScaler`) at its root,
    but also makes it simpler to apply to a dataset. For example, the user
