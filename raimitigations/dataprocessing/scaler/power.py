...
class DataPowerTransformer(DataScaler):
    """
    Concrete class that applies the PowerTransformer scaler over a given dataset.
    This class uses the sklearn's implementation of this scaler (PowerTransformer) at its
    ...
    all of the scalers in the pipeline will be applied before the PowerTransformer scaler.
    ...
    For more details on how the PowerTransformer changes the data, check the official
    documentation from sklearn:
    https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.PowerTransformer.html

    :param scaler_obj: an object from the PowerTransformer class. This
        sklearn scaler will be used to perform the scaling process. If None, a
        PowerTransformer is created using default values;
