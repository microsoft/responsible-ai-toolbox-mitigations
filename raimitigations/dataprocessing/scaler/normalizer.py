...
class DataNormalizer(DataScaler):
    """
    Concrete class that applies the Normalizer scaler over a given dataset. This class
    uses the sklearn's implementation of this scaler (Normalizer) at its root, but
    ...
    all of the scalers in the pipeline will be applied before the Normalizer scaler.
    ...
    For more details on how the Normalizer scales the data, check the official
    documentation from sklearn:
    https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.Normalizer.html

    :param scaler_obj: an object from the Normalizer class. This sklearn
        scaler will be used to perform the scaling process. If None, a Normalizer
