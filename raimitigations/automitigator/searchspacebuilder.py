...
class SearchSpaceBuilder:
    ...
    def build(self):
        ...
        power_scaler = {
            "scaler_name": "power_scaler"
        }

        normalize_scaler = {
            "scaler_name": "normalize_scaler"
        }
        ...
        scaler = {
            "name": "scaler",
            "type": tune.choice([standard_scaler, robust_scaler, quantile_scaler, power_scaler, normalize_scaler, minmax_scaler])
        }
        ...
        imputer = {
            "name": "imputer",
            "type": tune.choice([basic_imputer, iterative_imputer, knn_imputer])
        }
        ...
        return { 
            "search_space": tune.choice(search_space_list)
        }