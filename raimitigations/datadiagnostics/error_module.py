class ErrorModule:
    ...
    def _predict(self, vals):
        ...
        """
        raise NotImplementedError("An error module must implement predict.")
    ...
    def get_erroneous_rows_in_col(self, col_vals) -> list:
        ...
        :param col_vals: aa list of values to predict distribution errors on
                ...
                :rtype: a list
        """
        raise NotImplementedError("An error module must implement get_erroneous_rows_in_col.")
    ...
    def description(self):
        ...
        """
        raise NotImplementedError("An error module must implement description.")
    ...
    def get_available_types(self) -> list:
        ...
        """
        raise NotImplementedError("An error module must implement get_available_types")
