...
def _is_addr(self, col_vals, addr_thresh):
    """
...
def _is_num(self, col_vals, num_thresh):
    """
...
def _is_cat(self, col_vals, cat_thresh):
    """
...
def _is_str(self, col_vals):
    #TODO: add content, use data_utils.py existing method
    # if type()==str and not categorical, has to be after categorical in the ifs in get_columns_datatypes()
    return
