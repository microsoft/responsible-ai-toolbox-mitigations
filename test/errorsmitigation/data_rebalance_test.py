...
hr_data_Small = copy.deepcopy(pytest.hr_promotion_TEST)
...
# Performance tests for Rebalance API

rebal_data_perf = [
    (hr_data_10, target_index_promoted, "auto", 42, None, smote, None, "equal"),
    (hr_data_30, target_index_promoted, "auto", 42, None, smote, None, "equal"),
    (hr_data_50, target_index_promoted, "auto", 42, None, smote, None, "equal"),
    (hr_data_10, target_index_promoted, "auto", 42, None, None, tomek, "equal"),
    (hr_data_30, target_index_promoted, "auto", 42, None, None, tomek, "equal"),
    (hr_data_50, target_index_promoted, "auto", 42, None, None, tomek, "equal"),
    (hr_data_10, target_index_promoted, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_30, target_index_promoted, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_50, target_index_promoted, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_10, target_index_promoted, "auto", 42, smote_tomek, None, None, "equal"),
    (hr_data_30, target_index_promoted, "auto", 42, smote_tomek, None, None, "equal"),
    (hr_data_50, target_index_promoted, "auto", 42, smote_tomek, None, None, "equal"),
    (
        hr_data_10,
    ...
    (hr_data_10, target_index_gender_f, "auto", 42, None, smote, None, "equal"),
    (hr_data_30, target_index_gender_f, "auto", 42, None, smote, None, "equal"),
    (hr_data_50, target_index_gender_f, "auto", 42, None, smote, None, "equal"),
    (hr_data_10, target_index_gender_f, "auto", 42, None, None, tomek, "equal"),
    (hr_data_30, target_index_gender_f, "auto", 42, None, None, tomek, "equal"),
    (hr_data_50, target_index_gender_f, "auto", 42, None, None, tomek, "equal"),
    (hr_data_10, target_index_gender_f, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_30, target_index_gender_f, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_50, target_index_gender_f, "auto", 42, None, smote, tomek, "equal"),
    (hr_data_10, target_index_gender_f, "auto", 42, smote_tomek, None, None, "equal"),
    (hr_data_30, target_index_gender_f, "auto", 42, smote_tomek, None, None, "equal"),
    (hr_data_50, target_index_gender_f, "auto", 42, smote_tomek, None, None, "equal"),
    (hr_data_50, target_index_no_of_trainings, "auto", 42, None, smote, None, "equal"),
]
...
def test_data_rebal_perf(
    hr_data_set, target_index, random_state, seed, smote_tomek, smote, tomek, expected
):

    # handle duplicates
    hr_data = hr_data_set.drop_duplicates()
    # handle null values
    hr_data.dropna(inplace=True)
    # OneHotEncoder for categorical features
    hr_data = pd.get_dummies(hr_data, drop_first=False)

    target_index_column = hr_data.columns.get_loc(target_index)
    ...
    # converting to string for reporting the result
    random_state_str = str(random_state)
    seed_str = str(seed)
